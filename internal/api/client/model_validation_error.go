...
func NewValidationError(field string, message string, tag string, type_ string) *ValidationError {
...
func (o *ValidationError) GetTag() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ValidationError) GetTagOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Tag, true
...
func (o *ValidationError) SetTag(v string) {
	o.Tag = v
}
