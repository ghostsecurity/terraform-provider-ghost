...
// APIClient manages communication with the Ghost API API v2.0.0
...
type APIClient struct {
	...
	IssueCategoriesAPI *IssueCategoriesAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.IssueCategoriesAPI = (*IssueCategoriesAPIService)(&c.common)
